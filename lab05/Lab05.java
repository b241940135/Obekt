...
import java.util.Scanner; // Классын гадна байх ёстой

public class Lab05 {

    // 1. Overloaded Mean methods
	...
	public static void main(String[] args) {
        ...
        System.out.print("Heden toon deer statistic uildel guitsetgeh we? (2-5): ");
        if (!sc.hasNextInt()) {
            System.out.println("Aldaa: Buhel too oruulna uu.");
            return;
        }
        ...
        // Overloaded method-уудыг дуудаж байна
        switch (n) {
            case 2:
        ...
        // Varargs method-уудыг дуудаж байна
